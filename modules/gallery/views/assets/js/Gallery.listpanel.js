var Gallery = Gallery || {} ; 
Gallery.Util = Gallery.Util||{} ; 

Gallery.Util.uid = function(){
    var s4 = function(){
...
Gallery.Util.printf = function(str,oParam){ 
...
Gallery.Util.autolink = function(str){ 
...
Gallery.ListPanel = function(config){
    var url = config.url ,
        uid = Gallery.Util.uid(),
        ...
        xhrCall:function(param){
            ...
            $.getJSON(url,param ,function(data){
                ...
                for(var i = 0 ; i < items.length ; i++){ 
                    ...
                    var html = Gallery.Util.printf(item_config.tmpl,obj); 
    ...
    that.renderSelectedItem = function(selected_item){
        ...
        var html = Gallery.Util.printf(selected_item_config.tmpl,obj); 
    ...
    that.getContent = function(){
        ...
        for(var i= 0 ; i < selected_items.length ; i++){
            ...
            var html = Gallery.Util.printf(display_item_config.tmpl,obj); 
